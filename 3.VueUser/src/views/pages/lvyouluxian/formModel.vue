	...
	<div class="app-contain" :style='{"padding":"0 18%","margin":"0px auto","alignItems":"flex-start","flexWrap":"wrap","display":"flex","width":"100%","position":"relative","justifyContent":"space-between"}'>
		...
		<div class="detail_view">
			...
			<div class="info_view">
				...
				<div class="info_item">
					<div class="info_label">景点介绍</div>
					<div  class="info_text" >{{detail.jingdianjieshao}}</div>
				</div>
				<div class="info_item">
				...
				<div class="info_item">
					<div class="info_label">途径路段</div>
					<div  class="info_text" >{{detail.tujingluduan}}</div>
				</div>
				<div class="info_item">
				...
				<div class="info_item">
					<div class="info_label">路线介绍</div>
					<div  class="info_text" >{{detail.luxianjieshao}}</div>
				</div>
				<div class="info_item">
					<div class="info_label">行程天数</div>
					<div  class="info_text" >{{detail.xingchengtianshu}}</div>
				</div>
				<div class="info_item">
				...
				<div class="btn_view">
					<el-button v-if="centerType&&(detail.ispay=='未支付'||!detail.ispay)&&btnFrontAuth('lvyouluxian','支付')" class="approval_btn" @click="payClick">支付</el-button>
					<el-button class="edit_btn" v-if="centerType&&btnAuth('lvyouluxian','修改')" type="primary" @click="editClick">修改</el-button>
					<el-button class="del_btn" v-if="centerType&&btnAuth('lvyouluxian','删除')" type="danger" @click="delClick">删除</el-button>
				</div>
			</div>
		</div>
		<el-tabs type="border-card" v-model="activeName" class="tabs_view">
			<el-tab-pane label="行程安排" name="first">
				<div v-html="detail.xingchenganpai"></div>
			</el-tab-pane>
...
<script setup>
	...
	const getDetail = () => {
		context?.$http({
			...
			bannerList.value = res.data.data.luxiantupian?res.data.data.luxiantupian.split(','):[]
