				...
				<el-row>
					...
					<el-col :span="12">
						<el-form-item label="行程安排" prop="xingchenganpai">
							<editor :value="form.xingchenganpai" placeholder="请输入行程安排" :readonly="!isAdd||disabledForm.xingchenganpai?true:false"
								class="list_editor" @change="(e)=>editorChange(e,'xingchenganpai')"></editor>
						</el-form-item>
					</el-col>
				</el-row>
			</el-form>
...
<script setup>
	...
	const getInfo = ()=>{
		context?.$http({
			...
			res.data.data.xingchenganpai = res.data.data.xingchenganpai?(res.data.data.xingchenganpai.replace(reg,'../../../cl9446836/file')):'';
