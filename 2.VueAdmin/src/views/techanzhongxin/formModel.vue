				...
				<el-row>
					...
					<el-col :span="12">
						<el-form-item label="产地" prop="chandi">
							<el-input class="list_inp" v-model="form.chandi" placeholder="产地"
								 type="text" 								:readonly="!isAdd||disabledForm.chandi?true:false" />
						</el-form-item>
					</el-col>
					...
					<el-col :span="12">
						<el-form-item label="描述" prop="miaoshu">
							<el-input v-model="form.miaoshu" placeholder="描述" type="textarea"
							:readonly="!isAdd||disabledForm.miaoshu?true:false"
							/>
						</el-form-item>
					</el-col>
					<el-col :span="12">
...
<script setup>
	...
	const getInfo = ()=>{
		context?.$http({
			...
			res.data.data.xiangqing = res.data.data.xiangqing?(res.data.data.xiangqing.replace(reg,'../../../cl9446836/file')):'';
	...
	const init=(formId=null,formType='add',formNames='',row=null,table=null,statusColumnName=null,tips=null,statusColumnValue=null)=>{
		...
		if(formType == 'add'){
			...
			for(let x in row){
				...
				if(x=='chandi'){
					form.value.chandi = row[x];
					disabledForm.value.chandi = true;
					continue;
				}
				if(x=='miaoshu'){
